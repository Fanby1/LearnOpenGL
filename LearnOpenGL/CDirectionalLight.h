...
public:
	...
	~CDirectionalLight() = default;
	void setDirection(const Eigen::Vector3f& vDirection);
	void setAmbient(const Eigen::Vector3f& vAmbient);
	void setDiffuse(const Eigen::Vector3f& vDiffuse);
	void setSpecular(const Eigen::Vector3f& vSpecular);
